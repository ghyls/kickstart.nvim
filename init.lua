...
-- Disable netrw (recommended by nvim-tree, which replaces it)
...
require('lazy').setup({
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          ...
          layout_config = {
            vertical = {
              preview_height = 0.5, -- Preview takes up 50% of the height
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      -- markdown disabled: treesitter's indentexpr overrides gq/gw's list-continuation
      -- indent (formatlistpat), stripping the "  " hanging indent on wrapped "- " lines.
